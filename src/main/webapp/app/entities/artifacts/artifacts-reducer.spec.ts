...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './artifacts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTIFACTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTIFACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTIFACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTIFACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTIFACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTIFACTS actions', async () => {
      const expectedActions = [
        {
