...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './roles.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROLES actions', async () => {
      const expectedActions = [
        {
