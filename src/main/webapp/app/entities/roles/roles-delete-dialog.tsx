...
export const RolesDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(rolesEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="processComposerApp.roles.delete.question">
        <Translate contentKey="processComposerApp.roles.delete.question" interpolate={{ id: rolesEntity.id }}>
