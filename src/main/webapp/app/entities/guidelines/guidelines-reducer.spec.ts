...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GUIDELINES_LIST actions', async () => {
    ...
    it('dispatches FETCH_GUIDELINES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GUIDELINES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GUIDELINES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GUIDELINES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GUIDELINES actions', async () => {
      const expectedActions = [
        {
