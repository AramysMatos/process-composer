...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './phase.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHASE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHASE actions', async () => {
      const expectedActions = [
        {
