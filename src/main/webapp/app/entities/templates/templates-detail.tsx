...
export const TemplatesDetail = () => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="templatesDetailsHeading">
          <Translate contentKey="processComposerApp.templates.detail.title">Templates</Translate>
        </h2>
