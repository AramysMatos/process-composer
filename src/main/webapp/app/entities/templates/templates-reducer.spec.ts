...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './templates.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATES actions', async () => {
      const expectedActions = [
        {
