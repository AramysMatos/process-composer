...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tools.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOOLS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOOLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOOLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOOLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOOLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOOLS actions', async () => {
      const expectedActions = [
        {
