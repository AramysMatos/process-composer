...
export const ActivityDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="processComposerApp.activity.delete.question">
        <Translate contentKey="processComposerApp.activity.delete.question" interpolate={{ id: activityEntity.id }}>
