...
export const ProjectDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="processComposerApp.project.delete.question">
        <Translate contentKey="processComposerApp.project.delete.question" interpolate={{ id: projectEntity.id }}>
