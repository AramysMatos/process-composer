...
class TaskResourceIT {
    ...
    private static final String DEFAULT_GIT_HUB_URL = "AAAAAAAAAA";
    private static final String UPDATED_GIT_HUB_URL = "BBBBBBBBBB";
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getGitHubUrl()).isEqualTo(DEFAULT_GIT_HUB_URL);
        assertThat(testTask.getGitHubNodeId()).isEqualTo(DEFAULT_GIT_HUB_NODE_ID);
    }
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].gitHubUrl").value(hasItem(DEFAULT_GIT_HUB_URL)))
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.gitHubUrl").value(DEFAULT_GIT_HUB_URL))
    ...
    void putExistingTask() throws Exception {
        ...
        assertThat(testTask.getGitHubUrl()).isEqualTo(UPDATED_GIT_HUB_URL);
        assertThat(testTask.getGitHubNodeId()).isEqualTo(UPDATED_GIT_HUB_NODE_ID);
    }
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).gitHubNodeId(UPDATED_GIT_HUB_NODE_ID);
