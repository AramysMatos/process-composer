...
class ProjectResourceIT {
    ...
    private static final String DEFAULT_GIT_HUB_TOKEN = "AAAAAAAAAA";
    private static final String UPDATED_GIT_HUB_TOKEN = "BBBBBBBBBB";

    private static final String DEFAULT_GIT_HUB_REPOSITORY = "AAAAAAAAAA";
    private static final String UPDATED_GIT_HUB_REPOSITORY = "BBBBBBBBBB";

    private static final String DEFAULT_GIT_HUB_NODE_ID = "AAAAAAAAAA";
    private static final String UPDATED_GIT_HUB_NODE_ID = "BBBBBBBBBB";
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project()
            ...
            .gitHubToken(DEFAULT_GIT_HUB_TOKEN)
            .gitHubRepository(DEFAULT_GIT_HUB_REPOSITORY)
            .gitHubNodeId(DEFAULT_GIT_HUB_NODE_ID);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project()
            ...
            .gitHubToken(UPDATED_GIT_HUB_TOKEN)
            .gitHubRepository(UPDATED_GIT_HUB_REPOSITORY)
            .gitHubNodeId(UPDATED_GIT_HUB_NODE_ID);
        return project;
    }
    ...
    void createProject() throws Exception {
        ...
        assertThat(testProject.getGitHubToken()).isEqualTo(DEFAULT_GIT_HUB_TOKEN);
        assertThat(testProject.getGitHubRepository()).isEqualTo(DEFAULT_GIT_HUB_REPOSITORY);
        assertThat(testProject.getGitHubNodeId()).isEqualTo(DEFAULT_GIT_HUB_NODE_ID);
    }
    ...
    void putExistingProject() throws Exception {
        ...
        assertThat(testProject.getGitHubToken()).isEqualTo(UPDATED_GIT_HUB_TOKEN);
        assertThat(testProject.getGitHubRepository()).isEqualTo(UPDATED_GIT_HUB_REPOSITORY);
        assertThat(testProject.getGitHubNodeId()).isEqualTo(UPDATED_GIT_HUB_NODE_ID);
    }
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).gitHubRepository(UPDATED_GIT_HUB_REPOSITORY).gitHubNodeId(UPDATED_GIT_HUB_NODE_ID);
